...
/** Root component managing open state for a popover. */
...
/** Floating panel rendered when the popover is open. */
...
/** Layout wrapper grouping a popover's title and description. */
