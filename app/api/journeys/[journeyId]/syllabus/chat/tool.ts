...
- Use concise chapter titles (noun phrases, ≤ 120 chars). Add a short overview only when it adds clarity.
  ...
  "chapters": [
    {
      ...
      "overview": "Geographic and political foundations of Rome's rise.",
      "sections": ["Geography and early settlements", "The founding myths"]
    },
    {
      "title": "The Republic",
      "overview": "Rome's republican system, its political tensions, and expansion through conflict.",
